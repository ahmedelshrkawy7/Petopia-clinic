...
const floatingCard =
  "absolute flex items-center gap-3 rounded-3xl border border-[rgba(201,196,209,0.3)] bg-white/95 p-[15px] shadow-[0_14px_30px_0_rgba(28,27,32,0.08)] backdrop-blur-md"
...
export function HeroSection({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute -top-16 -right-20 size-[550px] rounded-full bg-[radial-gradient(circle,rgba(207,201,254,0.5)_0%,rgba(207,201,254,0)_70%)] blur-[20px]"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute bottom-10 left-10 size-[350px] rounded-full bg-[rgba(207,201,254,0.2)] blur-[32px]"
      />

      <div className="relative page-container grid items-center gap-12 pt-10 pb-20 lg:grid-cols-2 lg:pt-14 lg:pb-24">
        {/* Copy & CTAs */}
        <div className="flex flex-col items-start gap-6">
          <div className="flex items-center gap-2 rounded-full border border-primary/20 bg-[#efeafd] px-4 py-[7px] shadow-xs">
            <span className="size-2 shrink-0 rounded-full bg-primary" />
            <img src={awardIcon} alt="" className="h-[14.875px] w-[15.583px]" />
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            ...
            <Button
              ...
              className="h-auto gap-2 rounded-3xl border-[#c9c4d1] bg-white px-[25px] py-[15px] text-base font-semibold shadow-xs"
            >
              <img src={playCircleIcon} alt="" className="size-[16.667px]" />
              Explore Services
            </Button>
          </div>

          <div className="flex w-full items-center gap-4 border-t border-[rgba(201,196,209,0.4)] pt-[17px]">
            <div className="flex shrink-0">
              {petParents.map((src) => (
                <img
                  ...
                  src={src}
                  alt="Pet parent"
                  className="-mr-2.5 size-9 rounded-full object-cover shadow-[0_0_0_2px_white]"
                />
              ))}
              <span className="flex size-9 items-center justify-center rounded-full bg-primary text-xs font-bold text-white shadow-[0_0_0_2px_white]">
                5k+
              </span>
            </div>
        ...
        <div className="relative mx-3 lg:mx-0">
          <div className="relative overflow-hidden rounded-[42px] border-4 border-white bg-[#6a63a9] p-1 shadow-2xl">
            <img
              src={heroDog}
            ...
            <div className="absolute top-4 left-4 flex items-center gap-2 rounded-3xl border border-[rgba(235,231,237,0.7)] bg-white/85 px-[15px] py-[7px] shadow-md backdrop-blur-md">
          ...
          <div className={cn(floatingCard, "-top-5 -left-3 lg:-left-8")}>
            <span className="flex size-11 shrink-0 items-center justify-center rounded-2xl bg-[#fef2f2] shadow-xs">
              <img src={asteriskIcon} alt="" className="h-[18px] w-[17.3px]" />
            </span>
            <span className="flex flex-col">
              <span className="text-[11px] leading-[16.5px] font-bold tracking-[0.55px] text-[#dc2626] uppercase">
                Immediate support
              </span>
          ...
          <div className={cn(floatingCard, "-right-3 -bottom-6 lg:-right-6")}>
            <span className="flex size-11 shrink-0 items-center justify-center rounded-2xl bg-[#ecfdf5] shadow-xs">
            ...
            <span className="flex flex-col">
              <span className="flex items-center gap-1">
                ...
                <span className="rounded-full bg-[#d1fae5] px-1.5 text-[10px] leading-[15px] font-semibold text-[#065f46]">
                  Top 1%
                </span>
              </span>
